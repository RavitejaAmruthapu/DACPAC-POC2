...
$ConnectionString="server=$serverName;User ID=$userName;Password=$Password;Encrypt=True;TrustServerCertificate=True;Persist Security Info=False;Integrated Security=true"
